...
class RssFeedsControllerTest < ActionController::TestCase
  ...
  test "should create rss_feed" do
    assert_difference('RssFeed.count') do
      post :create, rss_feed: { description: @rss_feed.description, feed_url: @rss_feed.feed_url, name: @rss_feed.name }
    end
  ...
  test "should update rss_feed" do
    patch :update, id: @rss_feed, rss_feed: { description: @rss_feed.description, feed_url: @rss_feed.feed_url, name: @rss_feed.name }
    assert_redirected_to rss_feed_path(assigns(:rss_feed))
  end
